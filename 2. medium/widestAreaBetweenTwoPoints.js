...
Return the widest vertical area between two points
such that no points are inside the area.

A vertical area is an area of fixed-width extending infinitely
along the y-axis (i.e., infinite height). 
he widest vertical area is the one with the maximum width.
...
Output: 1
Explanation: Both possible areas are optimal.
